...
[![Available on PyPI](https://img.shields.io/badge/v0.1.12-version?color=43cd0f&style=flat&label=pypi)](https://pypi.org/project/token-throttle)
...
```bash
pip install "token-throttle[redis,tiktoken]>=0.1.12,<0.2.0"
```
