...
<a href="https://pypi.org/project/multi-resource-rate-limiter"><img src="https://img.shields.io/badge/v0.1.4-version?color=43cd0f&style=flat&label=pypi" alt="PyPI version" /></a>
...
```bash
pip install "multi-resource-rate-limiter>=0.1.4,<0.2.0"
```
